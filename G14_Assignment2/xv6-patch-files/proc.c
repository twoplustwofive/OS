...
found:
  ...
  //initialize numberOfContextSwitches equal to 0
  p->numberOfContextSwitches=0;
  //initialize burst_time equal to 0
  p->burst_time = 0;
...
//               if((p1->state == RUNNABLE) && (highP->burst_time > p1->burst_time))
//                 highP = p1;
//             }
//       if(highP!=0)
//         p = highP;
